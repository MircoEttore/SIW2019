...
<body id="page-top" >
   ...
   <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">MicroK Music Store</a>
     ...
     <header class="mainpagehead">
      <div class="container" style="opacity: 20% ;">
        <div class="intro-text">
          <div class="intro-heading text-uppercase" >Benvenuto !</div>
          <div class="intro-lead-in" style="color : #000000; ; ">La tua musica a portata di mano </div>
