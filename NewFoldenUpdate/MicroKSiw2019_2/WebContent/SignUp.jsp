								...
								<div class="card-body">
									...
									<div class="md-form">
										<label for="form1" class="active">Il tuo Nome</label> <i
											...
											type="text" name="nome" class="white-text form-control">

									</div>
									<div class="md-form">
										<label for="form2" class="active">Il tuo Cognome</label> <i
											class="fa fa-user prefix white-text active"></i> <input
											type="text" name="cognome" class="white-text form-control">

									</div>
									<div class="md-form">
										<label for="form3" class="active">La tua email</label> <i
											class="fa fa-envelope prefix white-text active"></i> <input
											type="text" name="email" class="white-text form-control">

									</div>
									<div class="md-form">
										<label for="form4">La tua password</label> <i
											class="fa fa-lock prefix white-text active"></i> <input
											type="text" name="password" class="white-text form-control">

									</div>
									<div class="md-form">
										<label for="form5">Indirizzo</label> <i
											class="fa fa-lock prefix white-text active"></i> <input
											type="text" name="indirizzo" class="white-text form-control">

									</div>
									<div class="md-form">
										<label for="form5">Nickname</label> <i
											class="fa fa-lock prefix white-text active"></i> <input
											type="text" name="nickname" class="white-text form-control">
